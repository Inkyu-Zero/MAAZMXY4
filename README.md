...
| **清日常** | 自动完成每日日常：扫荡竞技场 / 斗宠大会 / 守护须弥山 / 噩梦诛仙四剑 / 噩梦冥河老祖，每项可单独开关 |
...
**清日常 5 项**：
1. 扫荡竞技场（自动扫荡 10 次后关闭）
2. 打斗宠大会（最多挑战 10 次，战斗结束自动返回继续）
3. 扫荡守护须弥山（依次扫荡 城南 → 城东 → 城北）
4. 扫荡噩梦诛仙四剑（扫荡次数可配置）
5. 扫荡噩梦冥河老祖（扫荡次数可配置）
...
- **循环次数** / **卡死重启**（刷取灵魂用）
- 7 项奖励开关（领取奖励用）
- 扫荡竞技场 / 斗宠大会 / 须弥山 / 噩梦扫荡等开关（清日常用，扫荡次数可配置）
